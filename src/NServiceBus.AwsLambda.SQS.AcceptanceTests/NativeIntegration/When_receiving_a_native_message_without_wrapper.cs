namespace NServiceBus.AwsLambda.Tests.NativeIntegration
{
    ...
    {
        static readonly string MessageToSend = new XDocument(new XElement("NServiceBus.AwsLambda.Tests.NativeIntegration.NativeMessage", new XElement("ThisIsTheMessage", "Hello!"))).ToString();
        static readonly string FailingMessageToSend = new XDocument(new XElement("NServiceBus.AwsLambda.Tests.NativeIntegration.FailingNativeMessage", new XElement("ThisIsTheMessage", "Hello!"))).ToString();
        ...
        string GetHeaders(string s3Key = null, string messageId = null)
        {
            ...
            return JsonConvert.SerializeObject(nsbHeaders);
        }
